...
function checkEntityById(viewer, id) {
	const entity = viewer.entities.getById(id)
	return Cesium.defined(entity)
}

function removeEntityById(viewer, id) {
	const entity = viewer.entities.getById(id)
	if (Cesium.defined(entity)) 
	    viewer.entities.remove(entity)
}

function removeEntitiesById(viewer, ids) {
	ids.forEach(id => {
		removeEntityById(viewer, id)
	})
}

export { 
	addBillboard, addLabel, addMarker, getAllEntities, getEntitysByAttr, removeAllEntities, removeEntitiesByAttr, clickRemoveEntities, clickGetEntitties,
	checkEntityById,  removeEntityById, removeEntitiesById
};
